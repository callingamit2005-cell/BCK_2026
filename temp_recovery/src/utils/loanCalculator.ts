...
import { formatCurrency as formatCurrencyGlobal } from '@/config/currency';
...
/**
 * Formats a number as currency using the centralized configuration.
 * Currently set to Indian Rupee (₹) but can be adapted globally.
 * 
