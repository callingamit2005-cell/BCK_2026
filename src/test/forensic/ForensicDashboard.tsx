  ...
  return (
    <>
      ...
      <button 
        ...
        className="fixed bottom-4 left-4 z-[9999] p-2 bg-slate-900/50 text-[#999999] rounded-full hover:text-white transition-all"
      ...
      {isVisible && (
        <div className="fixed inset-0 z-[9998] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <Card className="w-full max-w-4xl bg-slate-900 border-border text-white shadow-2xl overflow-hidden">
            <CardHeader className="bg-slate-800/50 border-b border-border py-4 flex flex-row items-center justify-between">
              ...
              <Button variant="ghost" size="sm" onClick={() => setIsVisible(false)} className="text-[#666666] hover:text-white">Close</Button>
            </CardHeader>
            ...
            <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 overflow-y-auto max-h-[80vh]">
              ...
              <div className="space-y-4">
                <h3 className="text-[10px] font-bold text-[#666666] uppercase tracking-widest">Pressure Testing</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-[10px] font-bold text-[#666666] uppercase tracking-widest">UI Pressure</h3>
                <div className="grid grid-cols-2 gap-2">
              ...
              <div className="space-y-4">
                <h3 className="text-[10px] font-bold text-[#666666] uppercase tracking-widest">Resilience Simulation</h3>
                <div className="grid grid-cols-2 gap-2">
              ...
              <div className="space-y-4 md:col-span-2 bg-black/40 p-4 rounded-2xl border border-border">
                <h3 className="text-[10px] font-bold text-[#666666] uppercase tracking-widest">Live Runtime Health</h3>
...
const MetricItem = ({ icon, label, value, color = "", format = "raw" }: any) => (
  <div className="flex flex-col gap-1">
    <div className="flex items-center gap-2 text-[9px] font-black text-[#666666] uppercase">
      {icon} {label}
    </div>
