  ...
  return (
    <div className="fixed top-0 left-0 right-0 h-[48px] z-[110] bg-surface border-b border-border shadow-sm flex items-center justify-center px-4 overflow-hidden">
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-row items-center justify-center gap-4 md:gap-8">
        <p className="text-foreground text-xs md:text-xs font-bold uppercase tracking-wider truncate">
        ...
        <Link 
          to="/auth" 
          className="shrink-0 bg-foreground text-surface px-5 py-1.5 rounded-lg text-xs font-bold uppercase tracking-wider transition-all hover:bg-foreground/90 active:scale-95 flex items-center gap-2 shadow-md"
        >
          Access Beta
        </Link>
      </div>
