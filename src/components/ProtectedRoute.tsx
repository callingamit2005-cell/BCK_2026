  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background antialiased">
        <div className="flex flex-col items-center gap-8 p-8 bg-surface rounded-3xl border border-border shadow-2xl animate-in zoom-in-95 duration-500">
          ...
          <div className="text-center space-y-2">
            <p className="text-xs font-bold text-foreground uppercase tracking-wider animate-pulse">
