...
const PrivacyPolicy = () => (
  <LegalLayout title="Privacy Policy">
    <div className="max-w-4xl mx-auto bg-surface p-8 md:p-12 rounded-modal shadow-premium border-2 border-border/40 font-sans">
      ...
      {/* 📅 Date Badge */}
      <div className="inline-flex items-center justify-center bg-background border border-border text-text-muted text-xs font-black uppercase tracking-wider px-5 py-2.5 rounded-full mb-12 shadow-sm">
