...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface px-6 py-24 animate-fade-in font-body">
      <div className="max-w-2xl w-full text-center">
        <div className="relative inline-block mb-10">
          <div className="absolute inset-0 bg-primary/10 rounded-full blur-3xl opacity-50" />
          <div className="relative bg-background border-4 border-slate-100 p-10 rounded-full shadow-2xl transform hover:scale-110 transition-transform duration-500">
            <Wallet className="w-24 h-24 text-primary" strokeWidth={1.5} />
            <div className="absolute -top-1 -right-1 bg-foreground text-surface text-sm font-black px-4 py-1.5 rounded-full shadow-lg flex items-center gap-1">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
          ...
          <Link
            to="/contact"
            className="w-full sm:w-auto px-10 py-5 bg-background hover:bg-slate-100 text-foreground border-2 border-slate-200 rounded-2xl font-black text-xl flex items-center justify-center gap-3 transition-all"
          >
        ...
        <div className="mt-20 pt-10 border-t border-slate-100">
          <p className="text-base text-foreground font-black flex flex-wrap items-center justify-center gap-2">
