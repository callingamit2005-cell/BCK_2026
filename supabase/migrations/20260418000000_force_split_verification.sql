...
-- Migration: force_split_verification
-- Description: Defensive RPC that ensures splits are ALWAYS inserted or the transaction is rolled back.
-- Logic: After insertion, it verifies split count > 0.
